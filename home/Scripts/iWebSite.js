...
{result=[];for(var i=0;i<node.childNodes.length;++i)
...
{var pageURL=String(document.location).urlStringByDeletingQueryAndFragment();var pathURL=pageURL.stringByDeletingLastPathComponent();result=pathURL.stringByAppendingPathComponent(this);}
return result;}
...
req.open('GET',url,true);req.setRequestHeader('X-Requested-With','XMLHttpRequest');req.setRequestHeader('If-Modified-Since','Wed, 15 Nov 1995 00:00:00 GMT');if(req.overrideMimeType)
